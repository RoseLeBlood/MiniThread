...
namespace mn {
  ...
  public:
	...
	basic_counting_semaphore(const basic_counting_semaphore& o)
		: basic_semaphore(o), m_uiCount(o.m_uiCount), m_uiMaxCount(o.m_uiMaxCount)  { }

	basic_counting_semaphore(basic_counting_semaphore&& o)
		: basic_semaphore( mn::move(o)), m_uiCount( mn::move(o.m_uiCount)), m_uiMaxCount( mn::move(o.m_uiMaxCount))  { }
